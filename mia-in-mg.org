...
#+subtitle: Usando el sistema Burning Wheel (Mouse Guard RPG y Torchbearer)
#+author: Dorovich
...
** /Percepción/
Percepción mide cómo de consciente es tu personaje de lo que le rodea y cómo de atento está. Se pone a prueba, por ejemplo, cuando se busca información, pistas o bien divisar algo en la distancia.

| *Silbato* | *Percepción inicial* |
|-----------+----------------------|
| Cascabel  |                    2 |
| Rojo      |                    2 |
| Azul      |                    3 |
...
Los conflictos son una parte esencial del sistema. Se usan en situaciones que es necesario analizar tramo a tramo, como un combate, una discusión o una persecución, por ejemplo.
